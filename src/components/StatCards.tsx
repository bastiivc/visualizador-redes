  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      ...
      <div className="flex items-center gap-4 bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-lg">
        ...
        <div>
          <p className="text-xs font-medium text-slate-400">Archivos en Repositorio</p>
          <h3 className="text-xl font-bold text-white mt-0.5">{totalFiles}</h3>
          <p className="text-[10px] text-slate-500 mt-0.5 font-medium">
            <span className="text-cyan-400">{htmlCount} Redes PyVis</span> • <span className="text-purple-400">{pngCount} Imágenes PNG</span>
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-lg">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-500 mt-0.5">Espacio usado en Supabase / DB</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-lg">
        ...
        <div>
          <p className="text-xs font-medium text-slate-400">Nodos PyVis Detectados</p>
          <h3 className="text-xl font-bold text-white mt-0.5">{totalNodes}</h3>
          <p className="text-[10px] text-slate-500 mt-0.5">Nodos en redes interactivas</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-lg">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-500 mt-0.5">Supabase Storage Activo</p>
        </div>
      </div>
    </div>
  );
